...
一个安全、高效的**局域网内多 Agent 技能共享与协同工作平台**。支持多 Agent 之间的技能发现、同步与调用，数据完全在局域网内流转，确保企业数据安全。
...
- 项目主页：https://github.com/elephantrich/lan-agent-skills
- 问题反馈：https://github.com/elephantrich/lan-agent-skills/issues
